...
// use super::write::handle_write_command;
...
//             write_ahead_log: WriteAheadLog::create(write_ahead_log_path, write_ahead_index_path)
//                 .await?,
//             replicator,
//             receiver,
//             sender,
...
//     //             handle_write_command(message.key.clone(), message.value.clone()).await?;
//     //             println!(
